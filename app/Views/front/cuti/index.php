...
<script>
    function dataindex() {
        $('#table_index').DataTable({
            ...
            'ajax': {
                'url': '<?= site_url('user/cuti_izin/loaddata') ?>',
                'headers': {
    ...
    function deletedata(iddata) {
        ...
        $("#click_yes").off("click").on("click", function() {
            $.ajax({
                type: 'DELETE',
                url: "<?= site_url('user/cuti_izin/delete') ?>/" + iddata,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
    ...
    function editdata(iddata) {
        $.get("<?= site_url('user/cuti_izin/edit') ?>/" + iddata, function(data, status) {
    ...
    function adddata() {
        $('#editor_add').load('<?= site_url('user/cuti_izin/add') ?>', function() {
            $('#add').modal({
                show: true
            });
        });
