...
<head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url() ?>/favicon/img/logo/favicon.ico">
...
<body>
    ...
    <main class="main" id="top">
        ...
        <div class="container-fluid" data-layout="container">
            <?= $this->include('front/layout_profile/left_menu') ?>
            <div class="content">

                <?= $this->include('front/layout_profile/top_menu') ?>
                <!-- Render the content section -->
                <?= $this->renderSection('content') ?>

                <?= $this->include('front/layout_profile/modal_lg') ?>
                <?= $this->include('front/layout_profile/modal') ?>
            </div>
        </div>
    </main>
    <!-- ===============================================-->
