                                ...
                                <div class="card-body">
                                    <div class="presencecontent">
                                        ...
                                        <div class="presencedetail">
                                            ...
                                            <span style="color: white;"><?= esc($presensi['jam_in']) ?: 'Tidak Ada Data'; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="presencecontent">
                                        ...
                                        <div class="presencedetail">
                                            ...
                                            <span style="color: #e9ecef;"><?= esc($presensi['jam_out']) ?: 'Tidak Ada Data'; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card" style="background-color: #7E60BF;">
                                <div class="card-body">
                                    <div class="presencecontent">
                                        ...
                                        <div class="presencedetail">
                                            <h4 class="presencetitle">Masuk</h4>
                                            <span style="color: #e9ecef;">00:00:00</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-content mt-2" style="margin-bottom: 100px">
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel">
                        <ul class="listview image-listview">
                            <li>
                                <div class="item">
                                    <img src="<?= base_url() ?>/front/img/sample/avatar/avatar1.jpg" alt="image" class="image" />
                                    <div class="in">
