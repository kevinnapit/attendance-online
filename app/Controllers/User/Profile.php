...
class Profile extends BaseController
{
    ...
    function change_profile()
    {
        ...
        $detailAdmin = $this->model->find(session()->get('user_id'));
        if ($detailAdmin['username'] != $username) {
            $rules = [
                'username' => [
                    'rules' => 'is_unique[tb_users.username]',
                    'errors' => [
        ...
        if ($detailAdmin['email'] != $email) {
            $rules = [
                'email' => [
                    'rules' => 'is_unique[tb_users.email]',
                    'errors' => [
        ...
        $this->model->update(session()->get('user_id'), $dataUpdate);
        $akun = [
    ...
    function change_password()
    {
        ...
        $admin_id = session()->get('user_id'); // Replace with your own logic
    ...
    function change_picture()
    {
        ...
        $detail = $this->model->find(session()->get('user_id'));
        ...
        session()->set(['user_picture' => $newName]);
        return $this->respond([
            'status' => 'success',
